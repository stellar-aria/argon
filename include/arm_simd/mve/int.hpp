...
[[gnu::always_inline]] nce mve_pred16_t equal(uint8x16_t a, uint8x16_t b) { return vcmpeqq_u8(a, b); }
[[gnu::always_inline]] nce mve_pred16_t equal(uint8x16_t a, uint8x16_t b, mve_pred16_t p) { return vcmpeqq_m_u8(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(uint8x16_t a, uint8x16_t b) { return vcmpneq_u8(a, b); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(uint8x16_t a, uint8x16_t b, mve_pred16_t p) { return vcmpneq_m_u8(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t higher_or_same(uint8x16_t a, uint8x16_t b) { return vcmpcsq_u8(a, b); }
[[gnu::always_inline]] nce mve_pred16_t higher_or_same(uint8x16_t a, uint8x16_t b, mve_pred16_t p) { return vcmpcsq_m_u8(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t higher(uint8x16_t a, uint8x16_t b) { return vcmphiq_u8(a, b); }
...
[[gnu::always_inline]] nce mve_pred16_t higher(uint8x16_t a, uint8x16_t b, mve_pred16_t p) { return vcmphiq_m_u8(a, b, p); }
...
template <int imm>[[gnu::always_inline]] nce uint8x16_t decrement_duplicate(uint8x16_t inactive, uint32_t a, mve_pred16_t p) { return vddupq_m_n_u8(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint8x16_t decrement_duplicate(uint8x16_t inactive, uint32_t *a, mve_pred16_t p) { return vddupq_m_wb_u8(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint8x16_t decrement_wrap_duplicate(uint8x16_t inactive, uint32_t a, uint32_t b, mve_pred16_t p) { return vdwdupq_m_n_u8(inactive, a, b, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint8x16_t decrement_wrap_duplicate(uint8x16_t inactive, uint32_t *a, uint32_t b, mve_pred16_t p) { return vdwdupq_m_wb_u8(inactive, a, b, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint8x16_t increment_duplicate(uint8x16_t inactive, uint32_t a, mve_pred16_t p) { return vidupq_m_n_u8(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint8x16_t increment_duplicate(uint8x16_t inactive, uint32_t *a, mve_pred16_t p) { return vidupq_m_wb_u8(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint8x16_t increment_wrap_duplicate(uint8x16_t inactive, uint32_t a, uint32_t b, mve_pred16_t p) { return viwdupq_m_n_u8(inactive, a, b, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint8x16_t increment_wrap_duplicate(uint8x16_t inactive, uint32_t *a, uint32_t b, mve_pred16_t p) { return viwdupq_m_wb_u8(inactive, a, b, imm, p); }
...
[[gnu::always_inline]] nce mve_pred16_t equal(uint8x16_t a, uint8_t b) { return vcmpeqq_n_u8(a, b); }
[[gnu::always_inline]] nce mve_pred16_t equal(uint8x16_t a, uint8_t b, mve_pred16_t p) { return vcmpeqq_m_n_u8(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(uint8x16_t a, uint8_t b) { return vcmpneq_n_u8(a, b); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(uint8x16_t a, uint8_t b, mve_pred16_t p) { return vcmpneq_m_n_u8(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t higher_or_same(uint8x16_t a, uint8_t b) { return vcmpcsq_n_u8(a, b); }
[[gnu::always_inline]] nce mve_pred16_t higher_or_same(uint8x16_t a, uint8_t b, mve_pred16_t p) { return vcmpcsq_m_n_u8(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t higher(uint8x16_t a, uint8_t b) { return vcmphiq_n_u8(a, b); }
[[gnu::always_inline]] nce mve_pred16_t higher(uint8x16_t a, uint8_t b, mve_pred16_t p) { return vcmphiq_m_n_u8(a, b, p); }
...
template <int imm>[[gnu::always_inline]] nce uint8x16_t shift_right_round(uint8x16_t inactive, uint8x16_t a, mve_pred16_t p) { return vrshrq_m_n_u8(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint8x16_t shift_right(uint8x16_t inactive, uint8x16_t a, mve_pred16_t p) { return vshrq_m_n_u8(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint8x16_t shift_right_insert(uint8x16_t a, uint8x16_t b, mve_pred16_t p) { return vsriq_m_n_u8(a, b, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint8x16_t shift_left_saturate(uint8x16_t inactive, uint8x16_t a, mve_pred16_t p) { return vqshlq_m_n_u8(inactive, a, imm, p); }
...
[[gnu::always_inline]] nce uint8x16_t multiply_add_scalar(uint8x16_t m1, uint8x16_t m2, uint8_t add) { return vmlasq_n_u8(m1, m2, add); }
[[gnu::always_inline]] nce uint8x16_t multiply_add_scalar(uint8x16_t m1, uint8x16_t m2, uint8_t add, mve_pred16_t p) { return vmlasq_m_n_u8(m1, m2, add, p); }
...
template <int imm>[[gnu::always_inline]] nce uint8x16_t shift_left_carry(uint8x16_t a, uint32_t *b, mve_pred16_t p) { return vshlcq_m_u8(a, b, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_left_long_bottom(uint8x16_t a) { return vshllbq_n_u8(a, imm); }
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_left_long_bottom(uint8x16_t a, mve_pred16_t p) { return vshllbq_x_n_u8(a, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint8x16_t shift_left(uint8x16_t inactive, uint8x16_t a, mve_pred16_t p) { return vshlq_m_n_u8(inactive, a, imm, p); }
[[gnu::always_inline]] nce uint8x16_t shift_left(uint8x16_t a, int8x16_t b, mve_pred16_t p) { return vshlq_x_u8(a, b, p); }
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_left_long_top(uint8x16_t a, mve_pred16_t p) { return vshlltq_x_n_u8(a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint8x16_t shift_left(uint8x16_t a) { return vshlq_n_u8(a, imm); }
template <int imm>[[gnu::always_inline]] nce uint8x16_t shift_left_insert(uint8x16_t a, uint8x16_t b, mve_pred16_t p) { return vsliq_m_n_u8(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint8x16_t shift_right_narrow_saturate_top(uint8x16_t a, uint16x8_t b, mve_pred16_t p) { return vqshrntq_m_n_u16(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint8x16_t shift_right_narrow_round_bottom(uint8x16_t a, uint16x8_t b, mve_pred16_t p) { return vrshrnbq_m_n_u16(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint8x16_t shift_right_narrow_round_saturate_bottom(uint8x16_t a, int16x8_t b, mve_pred16_t p) { return vqrshrunbq_m_n_s16(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint8x16_t shift_right_narrow_round_saturate_top(uint8x16_t a, int16x8_t b, mve_pred16_t p) { return vqrshruntq_m_n_s16(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint8x16_t shift_right_narrow_saturate_bottom(uint8x16_t a, int16x8_t b, mve_pred16_t p) { return vqshrunbq_m_n_s16(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint8x16_t shift_right_narrow_saturate_top(uint8x16_t a, int16x8_t b, mve_pred16_t p) { return vqshruntq_m_n_s16(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint8x16_t shift_right_round(uint8x16_t a, mve_pred16_t p) { return vrshrq_x_n_u8(a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint8x16_t shift_right(uint8x16_t a, mve_pred16_t p) { return vshrq_x_n_u8(a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint8x16_t shift_left(uint8x16_t a, mve_pred16_t p) { return vshlq_x_n_u8(a, imm, p); }
...
[[gnu::always_inline]] nce mve_pred16_t equal(int8x16_t a, int8x16_t b) { return vcmpeqq_s8(a, b); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(int8x16_t a, int8x16_t b, mve_pred16_t p) { return vcmpneq_m_s8(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t greater_than_or_equal(int8x16_t a, int8x16_t b) { return vcmpgeq_s8(a, b); }
[[gnu::always_inline]] nce mve_pred16_t greater_than_or_equal(int8x16_t a, int8x16_t b, mve_pred16_t p) { return vcmpgeq_m_s8(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t greater_than(int8x16_t a, int8x16_t b) { return vcmpgtq_s8(a, b); }
[[gnu::always_inline]] nce mve_pred16_t greater_than(int8x16_t a, int8x16_t b, mve_pred16_t p) { return vcmpgtq_m_s8(a, b, p); }
...
[[gnu::always_inline]] nce mve_pred16_t equal(int8x16_t a, int8x16_t b, mve_pred16_t p) { return vcmpeqq_m_s8(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(int8x16_t a, int8x16_t b) { return vcmpneq_s8(a, b); }
[[gnu::always_inline]] nce mve_pred16_t less_than_or_equal(int8x16_t a, int8x16_t b) { return vcmpleq_s8(a, b); }
...
[[gnu::always_inline]] nce mve_pred16_t less_than_or_equal(int8x16_t a, int8x16_t b, mve_pred16_t p) { return vcmpleq_m_s8(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t less_than(int8x16_t a, int8x16_t b) { return vcmpltq_s8(a, b); }
...
[[gnu::always_inline]] nce mve_pred16_t less_than(int8x16_t a, int8x16_t b, mve_pred16_t p) { return vcmpltq_m_s8(a, b, p); }
...
[[gnu::always_inline]] nce int8x16_t multiply_add_double_round_saturate_high_scalar(int8x16_t m1, int8x16_t m2, int8_t add) { return vqrdmlashq_n_s8(m1, m2, add); }
[[gnu::always_inline]] nce int8x16_t multiply_add_double_round_saturate_high_scalar(int8x16_t m1, int8x16_t m2, int8_t add, mve_pred16_t p) { return vqrdmlashq_m_n_s8(m1, m2, add, p); }
...
[[gnu::always_inline]] nce int8x16_t multiply_add_scalar(int8x16_t m1, int8x16_t m2, int8_t add) { return vmlasq_n_s8(m1, m2, add); }
[[gnu::always_inline]] nce int8x16_t multiply_add_scalar(int8x16_t m1, int8x16_t m2, int8_t add, mve_pred16_t p) { return vmlasq_m_n_s8(m1, m2, add, p); }
...
template <int imm>[[gnu::always_inline]] nce int8x16_t shift_right_round(int8x16_t inactive, int8x16_t a, mve_pred16_t p) { return vrshrq_m_n_s8(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce int8x16_t shift_right(int8x16_t inactive, int8x16_t a, mve_pred16_t p) { return vshrq_m_n_s8(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce int8x16_t shift_right_insert(int8x16_t a, int8x16_t b, mve_pred16_t p) { return vsriq_m_n_s8(a, b, imm, p); }
template <int imm>[[gnu::always_inline]] nce int8x16_t shift_left_saturate(int8x16_t inactive, int8x16_t a, mve_pred16_t p) { return vqshlq_m_n_s8(inactive, a, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int8x16_t shift_right_narrow_saturate_top(int8x16_t a, int16x8_t b, mve_pred16_t p) { return vqshrntq_m_n_s16(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int8x16_t shift_right_narrow_round_bottom(int8x16_t a, int16x8_t b, mve_pred16_t p) { return vrshrnbq_m_n_s16(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int8x16_t shift_left(int8x16_t inactive, int8x16_t a, mve_pred16_t p) { return vshlq_m_n_s8(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce int16x8_t shift_left_long_bottom(int8x16_t a, mve_pred16_t p) { return vshllbq_x_n_s8(a, imm, p); }
template <int imm>[[gnu::always_inline]] nce int16x8_t shift_left_long_top(int8x16_t a, mve_pred16_t p) { return vshlltq_x_n_s8(a, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int8x16_t shift_left_carry(int8x16_t a, uint32_t *b, mve_pred16_t p) { return vshlcq_m_s8(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int8x16_t shift_left_insert(int8x16_t a, int8x16_t b, mve_pred16_t p) { return vsliq_m_n_s8(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int8x16_t shift_left(int8x16_t a, mve_pred16_t p) { return vshlq_x_n_s8(a, imm, p); }
...
[[gnu::always_inline]] nce mve_pred16_t equal(int8x16_t a, int8_t b) { return vcmpeqq_n_s8(a, b); }
[[gnu::always_inline]] nce mve_pred16_t equal(int8x16_t a, int8_t b, mve_pred16_t p) { return vcmpeqq_m_n_s8(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(int8x16_t a, int8_t b) { return vcmpneq_n_s8(a, b); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(int8x16_t a, int8_t b, mve_pred16_t p) { return vcmpneq_m_n_s8(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t greater_than_or_equal(int8x16_t a, int8_t b) { return vcmpgeq_n_s8(a, b); }
[[gnu::always_inline]] nce mve_pred16_t greater_than_or_equal(int8x16_t a, int8_t b, mve_pred16_t p) { return vcmpgeq_m_n_s8(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t greater_than(int8x16_t a, int8_t b) { return vcmpgtq_n_s8(a, b); }
...
[[gnu::always_inline]] nce mve_pred16_t greater_than(int8x16_t a, int8_t b, mve_pred16_t p) { return vcmpgtq_m_n_s8(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t less_than_or_equal(int8x16_t a, int8_t b) { return vcmpleq_n_s8(a, b); }
[[gnu::always_inline]] nce mve_pred16_t less_than_or_equal(int8x16_t a, int8_t b, mve_pred16_t p) { return vcmpleq_m_n_s8(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t less_than(int8x16_t a, int8_t b) { return vcmpltq_n_s8(a, b); }
[[gnu::always_inline]] nce mve_pred16_t less_than(int8x16_t a, int8_t b, mve_pred16_t p) { return vcmpltq_m_n_s8(a, b, p); }
...
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_left_long_bottom(uint16x8_t inactive, uint8x16_t a, mve_pred16_t p) { return vshllbq_m_n_u8(inactive, a, imm, p); }
...
[[gnu::always_inline]] nce mve_pred16_t not_equal(uint16x8_t a, uint16x8_t b) { return vcmpneq_u16(a, b); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(uint16x8_t a, uint16x8_t b, mve_pred16_t p) { return vcmpneq_m_u16(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t higher_or_same(uint16x8_t a, uint16x8_t b) { return vcmpcsq_u16(a, b); }
[[gnu::always_inline]] nce mve_pred16_t higher_or_same(uint16x8_t a, uint16x8_t b, mve_pred16_t p) { return vcmpcsq_m_u16(a, b, p); }
...
template <int imm>[[gnu::always_inline]] nce uint16x8_t decrement_duplicate(uint16x8_t inactive, uint32_t a, mve_pred16_t p) { return vddupq_m_n_u16(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint16x8_t decrement_duplicate(uint16x8_t inactive, uint32_t *a, mve_pred16_t p) { return vddupq_m_wb_u16(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint16x8_t decrement_wrap_duplicate(uint16x8_t inactive, uint32_t a, uint32_t b, mve_pred16_t p) { return vdwdupq_m_n_u16(inactive, a, b, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint16x8_t decrement_wrap_duplicate(uint16x8_t inactive, uint32_t *a, uint32_t b, mve_pred16_t p) { return vdwdupq_m_wb_u16(inactive, a, b, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint16x8_t increment_duplicate(uint16x8_t inactive, uint32_t a, mve_pred16_t p) { return vidupq_m_n_u16(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint16x8_t increment_duplicate(uint16x8_t inactive, uint32_t *a, mve_pred16_t p) { return vidupq_m_wb_u16(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint16x8_t increment_wrap_duplicate(uint16x8_t inactive, uint32_t a, uint32_t b, mve_pred16_t p) { return viwdupq_m_n_u16(inactive, a, b, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint16x8_t increment_wrap_duplicate(uint16x8_t inactive, uint32_t *a, uint32_t b, mve_pred16_t p) { return viwdupq_m_wb_u16(inactive, a, b, imm, p); }
...
[[gnu::always_inline]] nce mve_pred16_t equal(uint16x8_t a, uint16x8_t b) { return vcmpeqq_u16(a, b); }
[[gnu::always_inline]] nce mve_pred16_t higher(uint16x8_t a, uint16x8_t b) { return vcmphiq_u16(a, b); }
...
[[gnu::always_inline]] nce mve_pred16_t equal(uint16x8_t a, uint16x8_t b, mve_pred16_t p) { return vcmpeqq_m_u16(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t higher(uint16x8_t a, uint16x8_t b, mve_pred16_t p) { return vcmphiq_m_u16(a, b, p); }
...
[[gnu::always_inline]] nce mve_pred16_t equal(uint16x8_t a, uint16_t b) { return vcmpeqq_n_u16(a, b); }
[[gnu::always_inline]] nce mve_pred16_t equal(uint16x8_t a, uint16_t b, mve_pred16_t p) { return vcmpeqq_m_n_u16(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(uint16x8_t a, uint16_t b) { return vcmpneq_n_u16(a, b); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(uint16x8_t a, uint16_t b, mve_pred16_t p) { return vcmpneq_m_n_u16(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t higher_or_same(uint16x8_t a, uint16_t b) { return vcmpcsq_n_u16(a, b); }
[[gnu::always_inline]] nce mve_pred16_t higher_or_same(uint16x8_t a, uint16_t b, mve_pred16_t p) { return vcmpcsq_m_n_u16(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t higher(uint16x8_t a, uint16_t b) { return vcmphiq_n_u16(a, b); }
[[gnu::always_inline]] nce mve_pred16_t higher(uint16x8_t a, uint16_t b, mve_pred16_t p) { return vcmphiq_m_n_u16(a, b, p); }
...
[[gnu::always_inline]] nce uint16x8_t multiply_add_scalar(uint16x8_t m1, uint16x8_t m2, uint16_t add) { return vmlasq_n_u16(m1, m2, add); }
[[gnu::always_inline]] nce uint16x8_t multiply_add_scalar(uint16x8_t m1, uint16x8_t m2, uint16_t add, mve_pred16_t p) { return vmlasq_m_n_u16(m1, m2, add, p); }
...
template <int imm>[[gnu::always_inline]] nce uint32x4_t shift_left_long_bottom(uint16x8_t a, mve_pred16_t p) { return vshllbq_x_n_u16(a, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_left_carry(uint16x8_t a, uint32_t *b, mve_pred16_t p) { return vshlcq_m_u16(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_left_long_top(uint16x8_t inactive, uint8x16_t a, mve_pred16_t p) { return vshlltq_m_n_u8(inactive, a, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint32x4_t shift_left_long_top(uint16x8_t a, mve_pred16_t p) { return vshlltq_x_n_u16(a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_left(uint16x8_t a) { return vshlq_n_u16(a, imm); }
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_left_insert(uint16x8_t a, uint16x8_t b, mve_pred16_t p) { return vsliq_m_n_u16(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_left(uint16x8_t inactive, uint16x8_t a, mve_pred16_t p) { return vshlq_m_n_u16(inactive, a, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_right_round(uint16x8_t inactive, uint16x8_t a, mve_pred16_t p) { return vrshrq_m_n_u16(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_right(uint16x8_t inactive, uint16x8_t a, mve_pred16_t p) { return vshrq_m_n_u16(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_right_insert(uint16x8_t a, uint16x8_t b, mve_pred16_t p) { return vsriq_m_n_u16(a, b, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_left_saturate(uint16x8_t inactive, uint16x8_t a, mve_pred16_t p) { return vqshlq_m_n_u16(inactive, a, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_left_unsigned_saturate(uint16x8_t inactive, int16x8_t a, mve_pred16_t p) { return vqshluq_m_n_s16(inactive, a, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_right_narrow_round_saturate_bottom(uint16x8_t a, int32x4_t b, mve_pred16_t p) { return vqrshrunbq_m_n_s32(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_right_narrow_round_saturate_top(uint16x8_t a, int32x4_t b, mve_pred16_t p) { return vqrshruntq_m_n_s32(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_right_narrow_saturate_bottom(uint16x8_t a, int32x4_t b, mve_pred16_t p) { return vqshrunbq_m_n_s32(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_right_narrow_saturate_top(uint16x8_t a, int32x4_t b, mve_pred16_t p) { return vqshruntq_m_n_s32(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_right_narrow_saturate_top(uint16x8_t a, uint32x4_t b, mve_pred16_t p) { return vqshrntq_m_n_u32(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_right_narrow_round_bottom(uint16x8_t a, uint32x4_t b, mve_pred16_t p) { return vrshrnbq_m_n_u32(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_right_round(uint16x8_t a, mve_pred16_t p) { return vrshrq_x_n_u16(a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_right(uint16x8_t a, mve_pred16_t p) { return vshrq_x_n_u16(a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint16x8_t shift_left(uint16x8_t a, mve_pred16_t p) { return vshlq_x_n_u16(a, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int16x8_t shift_right_round(int16x8_t inactive, int16x8_t a, mve_pred16_t p) { return vrshrq_m_n_s16(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce int16x8_t shift_right(int16x8_t inactive, int16x8_t a, mve_pred16_t p) { return vshrq_m_n_s16(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce int16x8_t shift_right_insert(int16x8_t a, int16x8_t b, mve_pred16_t p) { return vsriq_m_n_s16(a, b, imm, p); }
template <int imm>[[gnu::always_inline]] nce int16x8_t shift_left_saturate(int16x8_t inactive, int16x8_t a, mve_pred16_t p) { return vqshlq_m_n_s16(inactive, a, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int16x8_t shift_right_narrow_saturate_top(int16x8_t a, int32x4_t b, mve_pred16_t p) { return vqshrntq_m_n_s32(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int16x8_t shift_right_narrow_round_bottom(int16x8_t a, int32x4_t b, mve_pred16_t p) { return vrshrnbq_m_n_s32(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int16x8_t shift_left_long_bottom(int16x8_t inactive, int8x16_t a, mve_pred16_t p) { return vshllbq_m_n_s8(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce int16x8_t shift_left_long_top(int16x8_t inactive, int8x16_t a, mve_pred16_t p) { return vshlltq_m_n_s8(inactive, a, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int32x4_t shift_left_long_top(int16x8_t a, mve_pred16_t p) { return vshlltq_x_n_s16(a, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int16x8_t shift_left_carry(int16x8_t a, uint32_t *b, mve_pred16_t p) { return vshlcq_m_s16(a, b, imm, p); }
template <int imm>[[gnu::always_inline]] nce int32x4_t shift_left_long_bottom(int16x8_t a) { return vshllbq_n_s16(a, imm); }
template <int imm>[[gnu::always_inline]] nce int32x4_t shift_left_long_bottom(int16x8_t a, mve_pred16_t p) { return vshllbq_x_n_s16(a, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int16x8_t shift_left_insert(int16x8_t a, int16x8_t b, mve_pred16_t p) { return vsliq_m_n_s16(a, b, imm, p); }
...
[[gnu::always_inline]] nce mve_pred16_t not_equal(int16x8_t a, int16x8_t b, mve_pred16_t p) { return vcmpneq_m_s16(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t greater_than_or_equal(int16x8_t a, int16x8_t b) { return vcmpgeq_s16(a, b); }
[[gnu::always_inline]] nce mve_pred16_t greater_than_or_equal(int16x8_t a, int16x8_t b, mve_pred16_t p) { return vcmpgeq_m_s16(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t greater_than(int16x8_t a, int16x8_t b) { return vcmpgtq_s16(a, b); }
[[gnu::always_inline]] nce mve_pred16_t greater_than(int16x8_t a, int16x8_t b, mve_pred16_t p) { return vcmpgtq_m_s16(a, b, p); }
...
[[gnu::always_inline]] nce mve_pred16_t equal(int16x8_t a, int16x8_t b) { return vcmpeqq_s16(a, b); }
[[gnu::always_inline]] nce mve_pred16_t equal(int16x8_t a, int16x8_t b, mve_pred16_t p) { return vcmpeqq_m_s16(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(int16x8_t a, int16x8_t b) { return vcmpneq_s16(a, b); }
[[gnu::always_inline]] nce mve_pred16_t less_than_or_equal(int16x8_t a, int16x8_t b) { return vcmpleq_s16(a, b); }
[[gnu::always_inline]] nce mve_pred16_t less_than_or_equal(int16x8_t a, int16x8_t b, mve_pred16_t p) { return vcmpleq_m_s16(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t less_than(int16x8_t a, int16x8_t b) { return vcmpltq_s16(a, b); }
...
[[gnu::always_inline]] nce mve_pred16_t less_than(int16x8_t a, int16x8_t b, mve_pred16_t p) { return vcmpltq_m_s16(a, b, p); }
...
[[gnu::always_inline]] nce mve_pred16_t equal(int16x8_t a, int16_t b) { return vcmpeqq_n_s16(a, b); }
[[gnu::always_inline]] nce mve_pred16_t equal(int16x8_t a, int16_t b, mve_pred16_t p) { return vcmpeqq_m_n_s16(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(int16x8_t a, int16_t b) { return vcmpneq_n_s16(a, b); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(int16x8_t a, int16_t b, mve_pred16_t p) { return vcmpneq_m_n_s16(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t greater_than_or_equal(int16x8_t a, int16_t b) { return vcmpgeq_n_s16(a, b); }
[[gnu::always_inline]] nce mve_pred16_t greater_than_or_equal(int16x8_t a, int16_t b, mve_pred16_t p) { return vcmpgeq_m_n_s16(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t greater_than(int16x8_t a, int16_t b) { return vcmpgtq_n_s16(a, b); }
[[gnu::always_inline]] nce mve_pred16_t greater_than(int16x8_t a, int16_t b, mve_pred16_t p) { return vcmpgtq_m_n_s16(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t less_than_or_equal(int16x8_t a, int16_t b) { return vcmpleq_n_s16(a, b); }
[[gnu::always_inline]] nce mve_pred16_t less_than_or_equal(int16x8_t a, int16_t b, mve_pred16_t p) { return vcmpleq_m_n_s16(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t less_than(int16x8_t a, int16_t b) { return vcmpltq_n_s16(a, b); }
[[gnu::always_inline]] nce mve_pred16_t less_than(int16x8_t a, int16_t b, mve_pred16_t p) { return vcmpltq_m_n_s16(a, b, p); }
...
[[gnu::always_inline]] nce int16x8_t multiply_add_double_round_saturate_high_scalar(int16x8_t m1, int16x8_t m2, int16_t add) { return vqrdmlashq_n_s16(m1, m2, add); }
[[gnu::always_inline]] nce int16x8_t multiply_add_double_round_saturate_high_scalar(int16x8_t m1, int16x8_t m2, int16_t add, mve_pred16_t p) { return vqrdmlashq_m_n_s16(m1, m2, add, p); }
...
[[gnu::always_inline]] nce int16x8_t multiply_add_scalar(int16x8_t m1, int16x8_t m2, int16_t add) { return vmlasq_n_s16(m1, m2, add); }
[[gnu::always_inline]] nce int16x8_t multiply_add_scalar(int16x8_t m1, int16x8_t m2, int16_t add, mve_pred16_t p) { return vmlasq_m_n_s16(m1, m2, add, p); }
[[gnu::always_inline]] nce int32_t multiply_subtract_dual_reduce_add(int16x8_t a, int16x8_t b) { return vmlsdavq_s16(a, b); }
template <int imm>[[gnu::always_inline]] nce int16x8_t shift_left(int16x8_t inactive, int16x8_t a, mve_pred16_t p) { return vshlq_m_n_s16(inactive, a, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int16x8_t shift_left(int16x8_t a, mve_pred16_t p) { return vshlq_x_n_s16(a, imm, p); }
...
[[gnu::always_inline]] nce mve_pred16_t not_equal(int32x4_t a, int32x4_t b, mve_pred16_t p) { return vcmpneq_m_s32(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t greater_than_or_equal(int32x4_t a, int32x4_t b) { return vcmpgeq_s32(a, b); }
[[gnu::always_inline]] nce mve_pred16_t greater_than_or_equal(int32x4_t a, int32x4_t b, mve_pred16_t p) { return vcmpgeq_m_s32(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t greater_than(int32x4_t a, int32x4_t b) { return vcmpgtq_s32(a, b); }
[[gnu::always_inline]] nce mve_pred16_t greater_than(int32x4_t a, int32x4_t b, mve_pred16_t p) { return vcmpgtq_m_s32(a, b, p); }
...
[[gnu::always_inline]] nce mve_pred16_t equal(int32x4_t a, int32x4_t b) { return vcmpeqq_s32(a, b); }
[[gnu::always_inline]] nce mve_pred16_t equal(int32x4_t a, int32x4_t b, mve_pred16_t p) { return vcmpeqq_m_s32(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(int32x4_t a, int32x4_t b) { return vcmpneq_s32(a, b); }
[[gnu::always_inline]] nce mve_pred16_t less_than_or_equal(int32x4_t a, int32x4_t b) { return vcmpleq_s32(a, b); }
[[gnu::always_inline]] nce mve_pred16_t less_than_or_equal(int32x4_t a, int32x4_t b, mve_pred16_t p) { return vcmpleq_m_s32(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t less_than(int32x4_t a, int32x4_t b) { return vcmpltq_s32(a, b); }
...
[[gnu::always_inline]] nce mve_pred16_t less_than(int32x4_t a, int32x4_t b, mve_pred16_t p) { return vcmpltq_m_s32(a, b, p); }
...
[[gnu::always_inline]] nce mve_pred16_t equal(int32x4_t a, int32_t b) { return vcmpeqq_n_s32(a, b); }
[[gnu::always_inline]] nce mve_pred16_t equal(int32x4_t a, int32_t b, mve_pred16_t p) { return vcmpeqq_m_n_s32(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(int32x4_t a, int32_t b) { return vcmpneq_n_s32(a, b); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(int32x4_t a, int32_t b, mve_pred16_t p) { return vcmpneq_m_n_s32(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t greater_than_or_equal(int32x4_t a, int32_t b) { return vcmpgeq_n_s32(a, b); }
[[gnu::always_inline]] nce mve_pred16_t greater_than_or_equal(int32x4_t a, int32_t b, mve_pred16_t p) { return vcmpgeq_m_n_s32(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t greater_than(int32x4_t a, int32_t b) { return vcmpgtq_n_s32(a, b); }
[[gnu::always_inline]] nce mve_pred16_t greater_than(int32x4_t a, int32_t b, mve_pred16_t p) { return vcmpgtq_m_n_s32(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t less_than_or_equal(int32x4_t a, int32_t b) { return vcmpleq_n_s32(a, b); }
[[gnu::always_inline]] nce mve_pred16_t less_than_or_equal(int32x4_t a, int32_t b, mve_pred16_t p) { return vcmpleq_m_n_s32(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t less_than(int32x4_t a, int32_t b) { return vcmpltq_n_s32(a, b); }
[[gnu::always_inline]] nce mve_pred16_t less_than(int32x4_t a, int32_t b, mve_pred16_t p) { return vcmpltq_m_n_s32(a, b, p); }
...
[[gnu::always_inline]] nce int32x4_t multiply_add_double_round_saturate_high_scalar(int32x4_t m1, int32x4_t m2, int32_t add) { return vqrdmlashq_n_s32(m1, m2, add); }
[[gnu::always_inline]] nce int32x4_t multiply_add_double_round_saturate_high_scalar(int32x4_t m1, int32x4_t m2, int32_t add, mve_pred16_t p) { return vqrdmlashq_m_n_s32(m1, m2, add, p); }
...
[[gnu::always_inline]] nce int32x4_t multiply_add_scalar(int32x4_t m1, int32x4_t m2, int32_t add) { return vmlasq_n_s32(m1, m2, add); }
[[gnu::always_inline]] nce int32x4_t multiply_add_scalar(int32x4_t m1, int32x4_t m2, int32_t add, mve_pred16_t p) { return vmlasq_m_n_s32(m1, m2, add, p); }
...
template <int imm>[[gnu::always_inline]] nce int32x4_t shift_right_round(int32x4_t inactive, int32x4_t a, mve_pred16_t p) { return vrshrq_m_n_s32(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce int32x4_t shift_right(int32x4_t inactive, int32x4_t a, mve_pred16_t p) { return vshrq_m_n_s32(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce int32x4_t shift_right_insert(int32x4_t a, int32x4_t b, mve_pred16_t p) { return vsriq_m_n_s32(a, b, imm, p); }
template <int imm>[[gnu::always_inline]] nce int32x4_t shift_left_saturate(int32x4_t inactive, int32x4_t a, mve_pred16_t p) { return vqshlq_m_n_s32(inactive, a, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int32x4_t shift_right_round(int32x4_t a, mve_pred16_t p) { return vrshrq_x_n_s32(a, imm, p); }
template <int imm>[[gnu::always_inline]] nce int32x4_t shift_right(int32x4_t a, mve_pred16_t p) { return vshrq_x_n_s32(a, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int32x4_t shift_left_long_bottom(int32x4_t inactive, int16x8_t a, mve_pred16_t p) { return vshllbq_m_n_s16(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce int32x4_t shift_left_long_top(int32x4_t inactive, int16x8_t a, mve_pred16_t p) { return vshlltq_m_n_s16(inactive, a, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int32x4_t shift_left_carry(int32x4_t a, uint32_t *b, mve_pred16_t p) { return vshlcq_m_s32(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int32x4_t shift_left(int32x4_t inactive, int32x4_t a, mve_pred16_t p) { return vshlq_m_n_s32(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce int32x4_t shift_left_insert(int32x4_t a, int32x4_t b, mve_pred16_t p) { return vsliq_m_n_s32(a, b, imm, p); }
...
template <int imm>[[gnu::always_inline]] nce int32x4_t shift_left(int32x4_t a, mve_pred16_t p) { return vshlq_x_n_s32(a, imm, p); }
...
template <int offset>[[gnu::always_inline]] nce void store_doubleword_scatter_base(uint64x2_t *addr, uint64x2_t value, mve_pred16_t p) { return vstrdq_scatter_base_wb_p_u64(addr, offset, value, p); }
...
template <int offset>[[gnu::always_inline]] nce void store_doubleword_scatter_base(uint64x2_t *addr, int64x2_t value, mve_pred16_t p) { return vstrdq_scatter_base_wb_p_s64(addr, offset, value, p); }
...
template <int imm>[[gnu::always_inline]] nce uint32x4_t shift_left_carry(uint32x4_t a, uint32_t *b, mve_pred16_t p) { return vshlcq_m_u32(a, b, imm, p); }
...
template <int offset>[[gnu::always_inline]] nce void store_word_scatter_base(uint32x4_t addr, int32x4_t value) { return vstrwq_scatter_base_s32(addr, offset, value); }
template <int offset>[[gnu::always_inline]] nce void store_word_scatter_base(uint32x4_t addr, int32x4_t value, mve_pred16_t p) { return vstrwq_scatter_base_p_s32(addr, offset, value, p); }
template <int offset>[[gnu::always_inline]] nce void store_word_scatter_base(uint32x4_t *addr, int32x4_t value) { return vstrwq_scatter_base_wb_s32(addr, offset, value); }
template <int offset>[[gnu::always_inline]] nce void store_word_scatter_base(uint32x4_t *addr, int32x4_t value, mve_pred16_t p) { return vstrwq_scatter_base_wb_p_s32(addr, offset, value, p); }
template <int imm>[[gnu::always_inline]] nce uint32x4_t shift_left_unsigned_saturate(uint32x4_t inactive, int32x4_t a, mve_pred16_t p) { return vqshluq_m_n_s32(inactive, a, imm, p); }
...
[[gnu::always_inline]] nce mve_pred16_t not_equal(uint32x4_t a, uint32x4_t b) { return vcmpneq_u32(a, b); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(uint32x4_t a, uint32x4_t b, mve_pred16_t p) { return vcmpneq_m_u32(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t higher_or_same(uint32x4_t a, uint32x4_t b) { return vcmpcsq_u32(a, b); }
[[gnu::always_inline]] nce mve_pred16_t higher_or_same(uint32x4_t a, uint32x4_t b, mve_pred16_t p) { return vcmpcsq_m_u32(a, b, p); }
[[gnu::always_inline]] nce uint32x4_t reverse_64bit(uint32x4_t a, mve_pred16_t p) { return vrev64q_x_u32(a, p); }
template <int imm>[[gnu::always_inline]] nce uint32x4_t decrement_duplicate(uint32x4_t inactive, uint32_t a, mve_pred16_t p) { return vddupq_m_n_u32(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint32x4_t decrement_duplicate(uint32x4_t inactive, uint32_t *a, mve_pred16_t p) { return vddupq_m_wb_u32(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint32x4_t decrement_wrap_duplicate(uint32x4_t inactive, uint32_t a, uint32_t b, mve_pred16_t p) { return vdwdupq_m_n_u32(inactive, a, b, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint32x4_t decrement_wrap_duplicate(uint32x4_t inactive, uint32_t *a, uint32_t b, mve_pred16_t p) { return vdwdupq_m_wb_u32(inactive, a, b, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint32x4_t increment_duplicate(uint32x4_t inactive, uint32_t a, mve_pred16_t p) { return vidupq_m_n_u32(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint32x4_t increment_duplicate(uint32x4_t inactive, uint32_t *a, mve_pred16_t p) { return vidupq_m_wb_u32(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint32x4_t increment_wrap_duplicate(uint32x4_t inactive, uint32_t a, uint32_t b, mve_pred16_t p) { return viwdupq_m_n_u32(inactive, a, b, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint32x4_t increment_wrap_duplicate(uint32x4_t inactive, uint32_t *a, uint32_t b, mve_pred16_t p) { return viwdupq_m_wb_u32(inactive, a, b, imm, p); }
...
[[gnu::always_inline]] nce mve_pred16_t equal(uint32x4_t a, uint32x4_t b) { return vcmpeqq_u32(a, b); }
[[gnu::always_inline]] nce mve_pred16_t higher(uint32x4_t a, uint32x4_t b) { return vcmphiq_u32(a, b); }
...
[[gnu::always_inline]] nce mve_pred16_t equal(uint32x4_t a, uint32x4_t b, mve_pred16_t p) { return vcmpeqq_m_u32(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t higher(uint32x4_t a, uint32x4_t b, mve_pred16_t p) { return vcmphiq_m_u32(a, b, p); }
...
[[gnu::always_inline]] nce mve_pred16_t equal(uint32x4_t a, uint32_t b) { return vcmpeqq_n_u32(a, b); }
[[gnu::always_inline]] nce mve_pred16_t equal(uint32x4_t a, uint32_t b, mve_pred16_t p) { return vcmpeqq_m_n_u32(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(uint32x4_t a, uint32_t b) { return vcmpneq_n_u32(a, b); }
[[gnu::always_inline]] nce mve_pred16_t not_equal(uint32x4_t a, uint32_t b, mve_pred16_t p) { return vcmpneq_m_n_u32(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t higher_or_same(uint32x4_t a, uint32_t b) { return vcmpcsq_n_u32(a, b); }
[[gnu::always_inline]] nce mve_pred16_t higher_or_same(uint32x4_t a, uint32_t b, mve_pred16_t p) { return vcmpcsq_m_n_u32(a, b, p); }
[[gnu::always_inline]] nce mve_pred16_t higher(uint32x4_t a, uint32_t b) { return vcmphiq_n_u32(a, b); }
[[gnu::always_inline]] nce mve_pred16_t higher(uint32x4_t a, uint32_t b, mve_pred16_t p) { return vcmphiq_m_n_u32(a, b, p); }
...
template <int offset>[[gnu::always_inline]] nce void store_word_scatter_base(uint32x4_t addr, uint32x4_t value) { return vstrwq_scatter_base_u32(addr, offset, value); }
template <int offset>[[gnu::always_inline]] nce void store_word_scatter_base(uint32x4_t addr, uint32x4_t value, mve_pred16_t p) { return vstrwq_scatter_base_p_u32(addr, offset, value, p); }
template <int offset>[[gnu::always_inline]] nce void store_word_scatter_base(uint32x4_t *addr, uint32x4_t value) { return vstrwq_scatter_base_wb_u32(addr, offset, value); }
...
template <int offset>[[gnu::always_inline]] nce void store_word_scatter_base(uint32x4_t *addr, uint32x4_t value, mve_pred16_t p) { return vstrwq_scatter_base_wb_p_u32(addr, offset, value, p); }
template <int imm>[[gnu::always_inline]] nce uint32x4_t shift_right_round(uint32x4_t inactive, uint32x4_t a, mve_pred16_t p) { return vrshrq_m_n_u32(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint32x4_t shift_right(uint32x4_t inactive, uint32x4_t a, mve_pred16_t p) { return vshrq_m_n_u32(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint32x4_t shift_right_insert(uint32x4_t a, uint32x4_t b, mve_pred16_t p) { return vsriq_m_n_u32(a, b, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint32x4_t shift_left_saturate(uint32x4_t inactive, uint32x4_t a, mve_pred16_t p) { return vqshlq_m_n_u32(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint32x4_t shift_left(uint32x4_t inactive, uint32x4_t a, mve_pred16_t p) { return vshlq_m_n_u32(inactive, a, imm, p); }
template <int imm>[[gnu::always_inline]] nce uint32x4_t shift_left_insert(uint32x4_t a, uint32x4_t b, mve_pred16_t p) { return vsliq_m_n_u32(a, b, imm, p); }
...
[[gnu::always_inline]] nce uint32x4_t multiply_add_scalar(uint32x4_t m1, uint32x4_t m2, uint32_t add) { return vmlasq_n_u32(m1, m2, add); }
[[gnu::always_inline]] nce uint32x4_t multiply_add_scalar(uint32x4_t m1, uint32x4_t m2, uint32_t add, mve_pred16_t p) { return vmlasq_m_n_u32(m1, m2, add, p); }
...
template <> [[gnu::always_inline]] nce int8x16_t uninitialized() { return vuninitializedq_s8(); }
template <> [[gnu::always_inline]] nce int16x8_t uninitialized() { return vuninitializedq_s16(); }
template <> [[gnu::always_inline]] nce int32x4_t uninitialized() { return vuninitializedq_s32(); }
template <> [[gnu::always_inline]] nce int64x2_t uninitialized() { return vuninitializedq_s64(); }
template <> [[gnu::always_inline]] nce uint8x16_t uninitialized() { return vuninitializedq_u8(); }
template <> [[gnu::always_inline]] nce uint16x8_t uninitialized() { return vuninitializedq_u16(); }
template <> [[gnu::always_inline]] nce uint32x4_t uninitialized() { return vuninitializedq_u32(); }
template <> [[gnu::always_inline]] nce uint64x2_t uninitialized() { return vuninitializedq_u64(); }
...
[[gnu::always_inline]] nce mve_pred16_t create_tail_predicate8(uint32_t a) { return vctp8q(a); }
[[gnu::always_inline]] nce mve_pred16_t create_tail_predicate16(uint32_t a) { return vctp16q(a); }
[[gnu::always_inline]] nce mve_pred16_t create_tail_predicate32(uint32_t a) { return vctp32q(a); }
[[gnu::always_inline]] nce mve_pred16_t create_tail_predicate64(uint32_t a) { return vctp64q(a); }
[[gnu::always_inline]] nce mve_pred16_t create_tail_predicate8(uint32_t a, mve_pred16_t p) { return vctp8q_m(a, p); }
[[gnu::always_inline]] nce mve_pred16_t create_tail_predicate16(uint32_t a, mve_pred16_t p) { return vctp16q_m(a, p); }
[[gnu::always_inline]] nce mve_pred16_t create_tail_predicate32(uint32_t a, mve_pred16_t p) { return vctp32q_m(a, p); }
[[gnu::always_inline]] nce mve_pred16_t create_tail_predicate64(uint32_t a, mve_pred16_t p) { return vctp64q_m(a, p); }
