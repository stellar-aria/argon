...
// template <int lane>[[gnu::always_inline]] nce void store3_lane(int8_t *ptr, int8x16x3_t val) { return vst3q_lane_s8(ptr, val, lane); }
// template <int lane>[[gnu::always_inline]] nce void store3_lane(uint8_t *ptr, uint8x16x3_t val) { return vst3q_lane_u8(ptr, val, lane); }
// template <int lane>[[gnu::always_inline]] nce void store3_lane(poly8_t *ptr, poly8x16x3_t val) { return vst3q_lane_p8(ptr, val, lane); }
