...
auto gather = describe("gather", ${
  ...
  it("Gathers into a new vector from the specified indices", [&](auto& self) mutable -> void {
  ...
  it("Gathers into multiple new vectors from the specified indices", [&](auto& self) mutable -> void {
